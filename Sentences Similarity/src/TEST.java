...
public class TEST {
	...
	private static String testSetPos = "X confuse with Y	Y confound with X\r\n" + 
	...
	private static String testSetNeg = "X expose to Y	X protect from Y\r\n" + 
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		PrintWriter writer = new PrintWriter("D:\\DSP3\\lem_positive.txt", "UTF-8");

		for (String line : testSetPos.split("\r\n")) {
			...
			writer.println(parts[0].charAt(0) + " " + path1 + " " + parts[0].charAt(parts[0].length() - 1) + "\t" + parts[1].charAt(0) + " " + path2 + " " + parts[1].charAt(parts[1].length() - 1));
			
		}
		writer.close();
		
		writer = new PrintWriter("D:\\DSP3\\lem_negative.txt", "UTF-8");

		for (String line : testSetNeg.split("\r\n")) {
			String[] parts = line.split("\t");
			String path1 = parts[0].substring(2, parts[0].lastIndexOf(' '));
			String path2 = parts[1].substring(2, parts[1].lastIndexOf(' '));
